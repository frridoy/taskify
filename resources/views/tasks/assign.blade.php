...
@section('content')
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('tasks.store') }}" method="POST">
                            ...
                            <div class="form-group mb-2">
                                <label for="task_name" class="form-label fw-bold">Task Name</label> <span
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="task_name" id="task_name"
                                        class="form-control border-start-0  @error('task_name') is-invalid @enderror"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="task_description" id="task_description" class="form-control border-start-0" rows="4"
                            ...
                            <!-- Date Limit -->
                            <div class="form-group mb-2">
                                <label for="dateLimit" class="form-label fw-bold">Date Limit</label> <span
                                    class="text-danger">*</span>
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0">
                                    ...
                                    <input type="date" name="dateLimit" id="dateLimit"
                                        class="form-control border-start-0 @error('dateLimit') is-invalid @enderror">
                                    @error('dateLimit')
                                        <p class="invalid-feedback">
                                            {{ $message }}
                                        </p>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input type="radio" id="emergency" name="task_urgency" value="emergency"
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="high_priority" name="task_urgency" value="high_priority"
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="normal_priority" name="task_urgency"
                                            value="normal_priority" class="form-check-input">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="low_priority" name="task_urgency" value="low_priority"
                                            class="form-check-input">
    ...
    <style>
        ...
        .card-header {
            ...
            /* Smaller padding for the header */
        }
