            ...
            <div class="meeting-details mt-4">
                ...
                <div class="meeting-content">
                    <div class="meeting-item">
                        ...
                        <span class="meeting-value">{{ \Carbon\Carbon::parse($notice->meeting_date_time)->format('l, F j, Y \a\t h:i A') }}</span>
                    </div>
                    <div class="meeting-item">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <div class="validity">
                        ...
                        <p class="expiry-date">Valid until: <span class="validity-date">{{ \Carbon\Carbon::parse($notice->expire_date)->format('F d, Y') }}</span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="footer-info">
                        <p class="small text-muted mb-0">This is an official notice from {{$organization_info->company_name}}. Please keep this document for your records.</p>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="signature-area text-end">
                        ...
                        <div class="signatory">
                            ...
                            <p class="signatory-name mb-0"><strong>{{ $notice->signatory_name ?? '[Authorized Person\'s Name]' }}</strong></p>
                            <p class="signatory-designation mb-0"><em>{{ $notice->signatory_designation ?? '[Designation]' }}</em></p>
